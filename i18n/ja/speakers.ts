...
const evan = {
  ...
  avatarUrl: `${BASE_URL}images/avatars/evan-you.png`,
  attendedIndex: 1,
...
export const SESSION_SPEAKERS: Speaker[] = [
  evan,
  {
    ...
    talkTrack: "hacomono",
    avatarUrl: `${BASE_URL}images/avatars/daniel-roe.png`,
    attendedIndex: 4,
    color: "purple",
...
Nuxt コアチームを率いる経験や、世界中の開発者コミュニティとの協働から得た知見をもとに、Daniel はパターン、落とし穴、そしてソフトウェアを「強靭で適応力があり、そして楽しく開発できるもの」にするための実践的な戦略を共有します。`
  ...
  },
  {
    ...
    talkTrack: "hacomono",
    avatarUrl: `${BASE_URL}images/avatars/johnson-chu.png`,
    attendedIndex: 5,
    color: "orange",
    // TODO:
  ...
  },
  {
    ...
    talkTrack: "hacomono",
    avatarUrl: `${BASE_URL}images/avatars/guillaume-chau.png`,
    attendedIndex: 6,
    color: "navy",
...
・オフライン同期エンジンはどのように作るのか？`
  ...
  },
  {
    ...
    talkTrack: "hacomono",
    avatarUrl: `${BASE_URL}images/avatars/baku-hashimoto.png`,
    attendedIndex: 7,
    color: "default",
  ...
  },
  {
    ...
    talkSchedule: "13:35 - 14:05",
    talkTrack: "mates",
    avatarUrl: `${BASE_URL}images/avatars/hi-ogawa.png`,
    attendedIndex: 8,
    color: "purple",
...
内部構造を理解することで、ソフトウェア開発ワークフローを改善するためのテストの書き方やとパフォーマンス最適化を学ぶことができます。`
  ...
  },
  {
    ...
    talkSchedule: "12:50 - 13:20",
    talkTrack: "mates",
    avatarUrl: `${BASE_URL}images/avatars/yuji-sugiura.png`,
    attendedIndex: 9,
    color: "orange",
...
これまで、どういった想いでOSS活動を続けてきたか、またそれはどういう内容だったのかを一挙に振り返ります。`
  ...
  },
  {
    ...
    talkSchedule: "12:50 - 13:20",
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/yamanoku.png`,
    color: "default",
  ...
  },
  {
    ...
    talkSchedule: "13:35 - 14:05",
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/neginasu.png`,
    color: "purple",
  ...
  },
  {
    ...
    talkSchedule: "14:20 - 14:50",
    talkTrack: "mates",
    avatarUrl: `${BASE_URL}images/avatars/todde-tv.jpg`,
    color: "orange",
  ...
  },
  {
    ...
    talkSchedule: "14:20 - 14:50",
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/naitokosuke.png`,
    color: "navy",
...
「面倒な作業」から「本質的な開発」へとシフトし、AI 時代の開発スタイルに最適化された環境構築の具体的な方法を、実際のコード例と導入時の注意点も含めて詳しくご紹介します。`,
  ...
  },
  {
    ...
    talkSchedule: "15:05 - 15:35",
    talkTrack: "mates",
    avatarUrl: `${BASE_URL}images/avatars/vados-cosmonic.png`,
    color: "purple",
  ...
  },
  {
    ...
    talkSchedule: "15:05 - 15:35",
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/hiranuma.jpg`,
    color: "default",
  ...
  },
  {
    ...
    avatarUrl: `${BASE_URL}images/avatars/wattanx.png`,
    color: "purple",
...
このセッションを通じて、より多くの開発者が “明日から現場で使える知識” と “仕組みへの理解” の両方を持ち帰り、効率的に Nuxt アプリケーションをテストできるようになることを目指します。`,
  ...
  },
  {
    ...
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/sayn0.jpg`,
    color: "orange",
  ...
  },
  {
    ...
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/yuichkun.jpg`,
    color: "navy",
...
DSP(音声信号処理)の予備知識は不要です。`,
  ...
  },
  {
    ...
    talkTrack: "feature",
    avatarUrl: `${BASE_URL}images/avatars/antfu.png`,
    color: "navy",
...
export const LT_SPEAKERS: Speaker[] = [
  {
    ...
    title: "フロントエンドエンジニア",
    avatarUrl: `${BASE_URL}images/avatars/ssssota.png`,
    color: "default",
  ...
  },
  {
    ...
    title: "ソフトウェアエンジニア",
    avatarUrl: `${BASE_URL}images/avatars/naokihaba.png`,
    color: "purple",
  ...
  },
  {
    ...
    title: "フロントエンジニア",
    avatarUrl: `${BASE_URL}images/avatars/tsuno.jpeg`,
    color: "orange",
  ...
  },
  {
    ...
    name: "Rinchoku",
    title: "エンジニア",
    avatarUrl: `${BASE_URL}images/avatars/rinchoku.jpg`,
    color: "navy",
  ...
  },
  {
    ...
    affiliation: "フリーランス",
    title: "フロントエンジニア",
    avatarUrl: `${BASE_URL}images/avatars/shiminori.jpg`,
    color: "default",
  ...
  },
  {
    ...
    affiliation: "株式会社ICS",
    title: "フロントエンドエンジニア",
    avatarUrl: `${BASE_URL}images/avatars/crayfisher_zari.jpg`,
    color: "purple",
  ...
  },
  {
    ...
    title: "シニアコンサルタント",
    avatarUrl: `${BASE_URL}images/avatars/yut0naga1.jpg`,
    color: "orange",
  ...
  },
  {
    ...
    title: "フロントエンドエンジニア",
    avatarUrl: `${BASE_URL}images/avatars/kaede-kato.png`,
    color: "navy",
...
export const PANEL_DISCUSSION_SPEAKERS: Speaker[] = [
  evan,
  {
    ...
    avatarUrl: `${BASE_URL}images/avatars/dan_abramov.png`,
    attendedIndex: 2,
    color: "purple",
    socialUrls: {
  ...
  },
  {
    ...
    avatarUrl: `${BASE_URL}images/avatars/dominikg.png`,
    attendedIndex: 3,
    color: "orange",
    socialUrls: {
  ...
  },
  {
    ...
    avatarUrl: `${BASE_URL}images/avatars/kiaking.png`,
    color: "navy",
    socialUrls: {
...
export const STUDENT_SUPPORT_SPEAKERS: Omit<Speaker, "id" | "color">[] = [
  {
    ...
    title: "Vue.js コアチームメンバー",
    avatarUrl: `${BASE_URL}images/avatars/kazupon.png`,
  },
  {
    name: "ubugeeei",
    affiliation: "株式会社メイツ",
    title: "Vue.js メンバー",
    avatarUrl: `${BASE_URL}images/avatars/ubugeeei.png`,
  },
  {
    name: "Anthony Fu",
